...
- **Server Resources** — Monitor CPU, memory, and transcoder load; the [SSE plugin](/sse-plugin) adds live CPU/RAM for Jellyfin and Emby

### Account Sharing Detection

Six ready-made automations to catch suspicious activity:
...
- **Discord Webhooks** — Instant notifications when your automations fire
