...
One route does accept a credential in a query string, `/backup/download/:filename?token=`, and that token is single use and expires after 60 seconds. It did not appear once in 8,552 request lines on that host. If you want certainty before you upload, check first:
