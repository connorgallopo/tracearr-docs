...
Paired devices use a **30-day rolling session**: any use within 30 days extends it, so a device you open regularly stays paired indefinitely. A device idle for more than 30 days needs to pair again.
