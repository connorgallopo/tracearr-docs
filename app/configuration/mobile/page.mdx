...
description: Set up the Tracearr mobile app for iOS and Android. Download links, QR code pairing, push notification setup, multi-server support, and troubleshooting.
---
