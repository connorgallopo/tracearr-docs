...
<Callout type="info">
Download the app: [App Store (iOS)](https://apps.apple.com/us/app/tracearr/id6755941553) · [Google Play (Android)](https://play.google.com/store/apps/details?id=com.tracearr.mobile)
</Callout>
...
<Callout type="info">
The pairing token expires after **15 minutes** and can only be used **once**. If it expires, click "Add Device" again to generate a new code.
</Callout>
...
<Callout type="info">
Devices paired before the authentication upgrade keep working on their existing tokens until they are re-paired; nothing expires them at 30 days. The 30-day rolling session applies to devices paired after upgrading.
</Callout>
