...
<Callout type="warning">
  Without an external URL configured, the QR code will contain your local
  network address, which won't work when you're away from home.
</Callout>
...
<Callout type="info">
  The pairing token expires after **5 minutes** and can only be used **once**.
  If it expires, click "Add Device" again to generate a new code.
</Callout>
