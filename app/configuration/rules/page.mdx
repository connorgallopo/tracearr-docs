...
| Setting | Description |
|---------|-------------|
| Delay | Seconds to wait before terminating (0-300), giving the user a moment to finish |
| Cooldown | Minutes to wait before terminating another stream from the same user |

<Callout type="warning">
Use this action carefully. Terminating streams can frustrate legitimate users if your rule conditions are too broad.
</Callout>
...
**Actions:** Send Message to Client: "Please try a lower quality or direct play", Terminate Stream (delay: 30 seconds)
