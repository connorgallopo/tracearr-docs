    ...
    >
      <div className="flex flex-col gap-8">
        ...
        <section
          ...
          className="rounded-lg bg-gray-500/5 px-4 py-3"
        >
        ...
        <section className="flex flex-col gap-3">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Copy this, then paste it into Automations → Import in your Tracearr.
            It carries the steps and the blanks above, nothing about the install
            it came from. Tracearr shows you a review first, and adds the
            automation paused so you can check it before turning it on.
          </p>
        ...
        {typeof template.discussionNumber === "number" ? (
          <section className="flex flex-col gap-3">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              This is the template&apos;s GitHub Discussion. Reacting needs a
              GitHub account, and that is the only limit on it, so read the
              counts as rough interest rather than as a score.
            </p>
