...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    },
    {
      ...
      lastModified: getLastModified('getting-started/installation/docker-ui/page.mdx'),
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
      url: `${baseUrl}/getting-started/installation/supervised`,
      lastModified: getLastModified('getting-started/installation/supervised/page.mdx'),
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
      url: `${baseUrl}/getting-started/installation/kubernetes`,
      lastModified: getLastModified('getting-started/installation/kubernetes/page.mdx'),
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
      url: `${baseUrl}/getting-started/installation/railway`,
      lastModified: getLastModified('getting-started/installation/railway/page.mdx'),
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
    ...
    {
      url: `${baseUrl}/configuration/requests`,
      lastModified: getLastModified('configuration/requests/page.mdx'),
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
    ...
    {
      url: `${baseUrl}/configuration/destinations`,
      lastModified: getLastModified('configuration/destinations/page.mdx'),
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
      url: `${baseUrl}/configuration/email`,
      lastModified: getLastModified('configuration/email/page.mdx'),
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
