...
This guide assumes you followed the [Quick Start](http://localhost:3005/getting-started/installation#quick-start) instructions to set up Tracearr with Docker Compose.
